...
go_repository(
    name = "com_github_hadrianl_ibapi",
    importpath = "github.com/hadrianl/ibapi",
    sum = "h1:8uEMpEGiaMlVLe2m6swPdbdwNxti8VRZ1bsZabgji3s=",
    version = "v0.0.0-20210128031619-f0e8fffe1f4e",
)
